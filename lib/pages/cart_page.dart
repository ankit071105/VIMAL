      ...
      child: Row(
        ...
        children: [
          ...
          ElevatedButton(onPressed: () {
            ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: "Ruk Ja Bhai Itn Bhi Jldi Ky Hai".text.xl.make(),));
          },
              style: ButtonStyle(
 ...
 final _cart = CartModel();
  ...
  Widget build(BuildContext context) {
    return _cart.items!.isEmpty
        ? "Kuch to order Kr dijiye Sir 🙏🏼".text.xl4.white.center.makeCentered()
        :  ListView.builder(
